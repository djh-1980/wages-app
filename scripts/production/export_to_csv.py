...
def export_payslips_summary(db_path="data/payslips.db", output_file="data/output/payslips_summary.csv"):
...
def export_job_items(db_path="data/payslips.db", output_file="data/output/job_items.csv"):
...
def export_client_summary(db_path="data/payslips.db", output_file="data/output/client_summary.csv"):
...
def export_job_type_summary(db_path="data/payslips.db", output_file="data/output/job_type_summary.csv"):
...
def export_weekly_summary(db_path="data/payslips.db", output_file="data/output/weekly_summary.csv"):
