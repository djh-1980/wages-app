...
```
❌ data/payslips/ (empty - files go elsewhere)
❌ logs/ (empty - will be created when needed)
❌ data/output/ (empty - not used)
❌ tests/ (empty - placeholder)
❌ data/runsheets/2021-2025/ (empty year folders)
❌ data/runsheets/manual/ (empty)
```
...
rmdir data/runsheets/2021 data/runsheets/2022 data/runsheets/2023 data/runsheets/2024 data/runsheets/2025
rmdir data/runsheets/manual
```
...
├── data/runsheets/data/backups/  # Keep backup folder only
